...
export default function Home() {
	...
	return (
		<div className='bg-zinc-50 dark:bg-zinc-900 h-screen w-full overflow-x-hidden'>
			<main className=''>
				<div>
					<div className='ml-6 mb-4 flex flex-row space-x-3 items-center'>
						<div className='h-8 w-2 bg-green-400 rounded-lg' />
						<h3 className='text-zinc-700 dark:text-zinc-100 font-semibold text-2xl '>Mais Vendidos 🚀</h3>
					</div>

...
export default function Product({ name, photo, description, price, category }: Props) {
    return (
        <div className='flex-shrink-0 bg-zinc-200 dark:bg-zinc-800 rounded-md shadow-sm h-fit w-fit p-10 border-2 border-zinc-300 hover:border-zinc-400 dark:border-zinc-800 hover:border-2 dark:hover:border-zinc-700'>
            <div className='flex flex-col items-center py-4'>
                ...
                <div className='text-zinc-800 dark:text-zinc-100 text-center font-bold mt-3'>
                    <span>{name}</span>
                </div>
                <div className='flex flex-row items-start space-x-1'>
                    <AiFillTag size={20} color='rgb(113 113 122)'/> 
                    <span className='text-sm text-right text-zinc-600 dark:text-zinc-500'>
                        {category}
                    </span>
                </div>
            </div>
            ...
            <div>
                <div>
                    <p className='text-zinc-800 dark:text-zinc-100 font-semibold text-right mt-2'>{price} €</p>
                </div>

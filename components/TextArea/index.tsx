...
export default function TextArea({ variant, ...rest }: Props) {
    ...
    const variants = {
        ...
        error: 'p-3 rounded-md bg-zinc-700 focus:outline-none focus:bg-zinc-600 border border-red-500 hover:bg-zinc-600 focus:border-red-500 placeholder:text-sm placeholder:text-red-400 transition duration-300 ease-in-out',
